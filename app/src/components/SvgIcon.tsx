...
const activitySvg: TSvgMap<Activity> = {
  ...
  [Activity.CLUB]: () => require('../../assets/icons/activities/dancing.svg').default,
  ...
  [Activity.GALLERY]: () => require('../../assets/icons/activities/art.svg').default,
  ...
  [Activity.POOL]: () => require('../../assets/icons/activities/swimming.svg').default,
